...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_gambar" class="form-control" id="exampleInputEmail1"
                            placeholder="Nama Menu">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Deskripsi</label>
                        <textarea class="form-control" name="deskripsi_gambar" placeholder="Deskripsi Gambar"
                            for="exampleInputEmail1"></textarea>
                    </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $deskripsi  = $_POST['deskripsi_gambar'];
            ...
            if (!in_array($type2, $tipe_diizinkan)) {
                ...
                $insert  = mysqli_query($koneksi, "INSERT INTO gambar VALUES (
                            null,
                             '" . $nama . "',
                               '" . $deskripsi . "',
                              '" . $newname . "',
